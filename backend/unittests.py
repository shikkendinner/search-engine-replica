...
def correct_crawler_out_wrong_comparison_unittest():
...
def check_repeated_words_unittest():
...
def check_resolved_from_unresolved_inverted_index_unittest():
...
if __name__ == "__main__":
    ...
    googleTest_bool = google_unittest()
    ...
    incorComp_bool = correct_crawler_out_wrong_comparison_unittest()
    ...
    repeated_words_in_lexicon_bool = check_repeated_words_unittest()
    ...
    check_res_from_unres_bool = check_resolved_from_unresolved_inverted_index_unittest()
