...
os.system("scp -o StrictHostKeyChecking=no -i puddle_key_pair.pem ./backend/crawler.py ubuntu@"+public_dns_name+":~")

os.system("scp -o StrictHostKeyChecking=no -i puddle_key_pair.pem ./backend/urls.txt ubuntu@"+public_dns_name+":~")

os.system("scp -o StrictHostKeyChecking=no -i puddle_key_pair.pem ./backend/searchEngine.py ubuntu@"+public_dns_name+":~")
